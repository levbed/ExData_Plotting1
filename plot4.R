...
## The first plot
with(data_subsetted, plot(Time,Global_active_power,type="l", ylab = "Global Active Power", xlab = "" ))

## The second plot
with(data_subsetted, plot(Time,Voltage,type="l", ylab = "Voltage", xlab = "datetime" ))
...
## The forth plot
with(data_subsetted, plot(Time,Global_reactive_power,type="l", ylab = "Global_reactive_power", xlab = "datetime" ))
